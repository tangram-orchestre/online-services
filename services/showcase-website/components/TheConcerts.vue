...
const concerts: Array<Concert> = [
  {
    ...
    program: [
      ...
      { name: "The life and time of Scrooge - The Last Sled", direction: "Alexis" },
  ...
  },
  {
    ...
    program: [
      ...
      { name: "Narnia - The Battle", direction: "Ryadh" },
      ...
      { name: "Lord of the Dance", direction: "Anice" },
    ],
  },
  {
